...
def app():
    st.title("SymBot Editor")
    time.sleep(0.05)
    st.header("Welcome to Editor AI")
    time.sleep(0.05)
    st.subheader("Our Editor AI crew is here to help you...")
    ...
    leader=Agent(
        ...
        backstory='you are an Awriter capable of writing article, essay, novel, news letter, research paper and book with the help of your crew members and by accessing real-time information and data',
        tools=[search_tool],
    ...
    member1=Agent(
        role='The best AI editor',
        goal='Define the Problem,research,Understand the Context,Identify the Root Cause,Brainstorm Solutions,Evaluate Alternatives,Select the Best Solution,Develop an Action Plan,Implement the Solution,Monitor and Evaluate,Information Retrieval,Language Translation,Text Generation,Task Automation,Learning and Education,Creative Writing',
        backstory='you are an AI editor capable of helping AI writer with the help of your crew members and by accessing to real-time information and data',
        verbose=True,
        llm=llm,
        allow_delegation=True,
    )
    ...
    member2=Agent(
        role='The best AI researcher',
        goal='Define the Problem,research,Understand the Context,Identify the Root Cause,Brainstorm Solutions,Evaluate Alternatives,Select the Best Solution,Develop an Action Plan,Implement the Solution,Monitor and Evaluate,Information Retrieval,Language Translation,Text Generation,Task Automation,Learning and Education,Creative Writing',
        backstory='you are an AI researcher capable of searching and researching anything with the help of your crew members and by accessing to real-time information and data',
        tools=[search_tool],
        utilities=[wikipedia,python_repl],
        verbose=True,
        llm=llm,
